                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <%
                                ...
                                double totalPrice = 0;
//                                String ss =session.getAttribute("coupon");
                                Object b = session.getAttribute("coupon");
//                                double a=0;

                                try {
//                                    a = Double.parseDouble(b.toString());
                                    totalPrice += o.getTotalMoney();
                                } catch (Exception e) {
                                }
//                                double totalPrice1 = totalPrice - a;
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${o.items}" var="i"> 
                                    ...
                                    <tr>
                                        <td class="image" data-title="No"><img src="${i.product.img}" alt="#"></td>
                                        <td class="product-des" data-title="Description">
                                            <p class="product-name"><a href="#">${i.product.pname} </a></p>
                                            <p class="product-des">${i.product.desc}</p>
                                        </td>
                                        <td class="price" data-title="Price"><span>${i.price}00VND</span></td>
                                            ...
                                            <div class="input-group">
                                                <div class="button minus">
                                                    <!--                                                    <button type="button" class="btn btn-primary btn-number" data-type="minus" data-field="quant[3]">
                                                                                                            <i class="ti-minus"></i>
                                                                                                            <a href="process2?num=-1&id=${i.product.id}"></a>
                                                                                                        </button>-->
                                                    <button>
                                                        <a href="process2?num=-1&id=${i.product.id}">-</a>
                                                    </button>
                                                </div>
                                                <input type="text" name="quant[3]" class="input-number"  data-min="1" data-max="100" readonly value="${i.quantity}">
...
<!--                                                    <button type="button" class="btn btn-primary btn-number" data-type="plus" data-field="quant[3]">
                                        ...
                                        <td class="total-amount" data-title="Total"><span>${i.price*i.quantity}00VND</span></td>
                                        <td class="action" data-title="Remove"><a href="process?id=${i.product.id}"><i class="ti-trash remove-icon"></i></a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
...
<!--                                        <div class="coupon">
                                ...
                                <div class="col-lg-4 col-md-7 col-12">
                                    <div class="right">
                                        <ul>
                                            <li>Tổng giỏ hàng<span><%= totalPrice%>00VND</span></li>
                                            <li>Phí ship<span>Free</span></li>
                                            <li class="last">Bạn phải trả<span><%= totalPrice%>00VND</span></li>
                                        </ul>
                                        <div class="button5">
