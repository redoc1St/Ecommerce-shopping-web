<%-- 
    ...
    Created on : Jan 15, 2022, 10:53:43 AM
    Author     : ACER
--%>
                    ...
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.html">List product</a></li>
                                    ...
                                    <form action="editproduct" >
                                        <table id="datatablesSimple">
                                            ...
                                            <c:forEach items="${p.allProduct}" var="o" >
                                                <tr>
                                                    <!--<td></td>-->
                                                    <td><input type="text"  name="id" value="${o.id}"></td>
                                                    <td>${o.pname}</td>

                                                    <td><input type="text" name="price" value="${o.price}"></td>
                                                    <td><input type="text" name="desc" value="${o.desc}"></td>
                                                    <td><input type="text" name="salePer" value="${o.salePer}"></td>
